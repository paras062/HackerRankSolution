# Write a python program that accepts a text and displays a string which contains the word with the largest frequency in the text and the frequency 
...
# 1. "Work like you do not need money love like         like 3
#   you have never been hurt and dance like no one 
#   is watching"

# 2. "Courage is not the absence of fear but            fear 2
# rather the judgement that something else is more
# important than fear"
